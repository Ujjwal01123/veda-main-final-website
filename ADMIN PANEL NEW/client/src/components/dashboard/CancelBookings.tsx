...
export function ManageCancelBookings() {
  ...
  const fetchCancelBookings = async () => {
    try {
      const res = await fetch(`${apiUrl}/api/bookings/status/cancel`);
      ...
      toast({
        title: "Error",
        description: "Failed to fetch cancelled bookings",
        variant: "destructive",
      });
    }
  };
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center space-y-4 py-8">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              View, edit, and manage all cancelled bookings efficiently
            </p>
          </div>
          ...
          <div className="text-center py-8">
            <div className="flex items-center justify-center gap-2 text-muted-foreground">
              ...
              <span className="text-sm">
                Manage all cancelled bookings efficiently
              </span>
              <Users className="w-4 h-4" />
            </div>
          </div>
