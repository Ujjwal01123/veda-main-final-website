...
//             </div>
//             <p className="text-muted-foreground max-w-lg mx-auto">
//               Upload <strong>exactly 3 banners</strong> for the Puja section,
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-spiritual-light/10 via-background to-accent/5 p-6">
//       <div className="max-w-4xl mx-auto space-y-8">
//         {/* Back Button */}
//         <Button
//           variant="ghost"
...
//           </div>
//           <p className="text-muted-foreground max-w-lg mx-auto">
//             Upload <strong>exactly 3 banners</strong> for the Puja section, each
//             with unique alt text and preview.
//           </p>
//         </div>
...
//           <Sparkles className="w-4 h-4" />
//           <span>
//             Ensure your Puja banners reflect divine energy & spiritual harmony.
//           </span>
//           <Sparkles className="w-4 h-4" />
//         </div>
//       </div>
...
//       if (res.data.success) {
//         alert("✅ Puja banner uploaded successfully!");
//         setImage(null);
//         setPreview(null);
//         setAltText("");
...
//           </div>
//           <p className="text-muted-foreground max-w-lg mx-auto">
//             Upload and preview your divine Puja banner with custom alt text for
//             SEO.
//           </p>
//         </div>
...
//               <img
//                 src={preview}
//                 alt={altText || "Puja Banner Preview"}
...
//                   id="altText"
//                   type="text"
//                   placeholder="e.g. Lord Shiva Puja setup with diyas"
//                   value={altText}
...
//           <Sparkles className="w-4 h-4" />
//           <span>
//             Ensure your Puja banner reflects divine energy & aesthetics.
//           </span>
//           <Sparkles className="w-4 h-4" />
//         </div>
//       </div>
