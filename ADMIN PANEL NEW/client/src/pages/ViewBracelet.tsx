...
export function ViewBracelet() {
    ...
    axios
      ...
      .then((res) => {
        ...
        if (data.productImage && data.productImage.length > 0)
          setMainImage(data.productImage[0]);
      })
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {/* Main Content */}
      <div className="flex-1 p-6 overflow-y-auto ml-64 container mx-auto px-4 py-12 space-y-8 max-w-7xl">
        <div className="flex justify-between items-center mb-6">
          ...
          >
            ...
            Back to manage bracelets
          </Button>
          <Button
            onClick={() => navigate(`/bracelet/edit/${bracelet._id}`)}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 p-6 bg-white dark:bg-card rounded-xl shadow-lg">
          <div className="lg:col-span-1 space-y-4">
            <div className="relative w-full aspect-square overflow-hidden rounded-xl shadow-inner border border-border">
              <img
                src={mainImage || bracelet.productImage[0]}
                alt={bracelet.productName}
                className="w-full h-full object-contain transition-transform duration-300 hover:scale-105"
              />
            </div>
            <div className="flex gap-2 overflow-x-auto p-1">
              {bracelet.productImage.map((img, idx) => (
                <button
                  key={idx}
                ...
                >
                  <img
                    src={img}
                    alt={`${bracelet.productName} ${idx + 1}`}
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <PriceDisplay
              price={bracelet.productPrice}
              discount={bracelet.productDiscount}
            />
            ...
            {bracelet.certificates.length > 0 && (
              <div className="space-y-2">
                <h3 className="text-lg font-semibold text-secondary-foreground">
                  Certificates
                </h3>
                <div className="flex gap-2 flex-wrap">
                  {bracelet.certificates.map((c) => (
                    <Badge
                      key={c._id}
                      variant="secondary"
                      className="py-1 px-3 text-sm border border-dashed border-primary/50 text-primary hover:bg-primary/10"
        ...
        {/* 🔗 Shopify & YouTube */}
        {(bracelet.shopifyLink || bracelet.youtubeLink) && (
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            {bracelet.shopifyLink && (
              <a
                href={bracelet.shopifyLink}
                target="_blank"
            ...
            {bracelet.youtubeLink && (
              <a
                href={bracelet.youtubeLink}
                target="_blank"
                rel="noopener noreferrer"
                className="relative flex items-center justify-between p-5 bg-white dark:bg-gray-800 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-200 dark:border-gray-700 group overflow-hidden"
              >
        ...
        {/* 🧾 HTML Details Sections */}
        <div className="space-y-6">
          {[
            {
              title: "About Product",
              html: parseHTML(bracelet.productAbout),
              icon: CircleCheck,
            },
            {
              title: "Key Features",
              html: parseHTML(bracelet.productFeatures),
              icon: Star,
            },
            {
              title: "Benefits",
              html: parseHTML(bracelet.productBenefits),
              icon: Star,
            },
            {
              title: "FAQs",
              html: parseHTML(bracelet.productFaqs),
              icon: Star,
            },
            {
              title: "Shipping Information",
              html: parseHTML(bracelet.productShipping),
              icon: Package,
            },
          ].map(
            (section) =>
          ...
          {/* 🔮 Energization */}
          {bracelet.energization.length > 0 && (
        ...
        {/* Shopify & YouTube Links and Details Sections */}
...
//   // Flatten nested JSON strings to a string array
...
//                 <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-blue-600 opacity-10 scale-110 blur-xl group-hover:opacity-25 transition-all duration-500 rounded-2xl"></div>
...
//               >
//                 {/* Soft background glow */}
//                 <div className="absolute inset-0 bg-gradient-to-r from-red-400 to-red-600 opacity-10 scale-110 blur-xl group-hover:opacity-25 transition-all duration-500 rounded-2xl"></div>
...
//             {
//               title: "About Product",
//               data: parseDetails(bracelet.productAbout),
//               icon: CircleCheck,
//             },
//             {
//               title: "Key Features",
//               data: parseDetails(bracelet.productFeatures),
//               icon: Star,
//             },
//             {
//               title: "Benefits",
//               data: parseDetails(bracelet.productBenefits),
//               icon: Star,
//             },
//             {
//               title: "FAQs",
//               data: parseDetails(bracelet.productFaqs),
//               icon: Star,
//             },
//             {
//               title: "Shipping Information",
//               data: parseDetails(bracelet.productShipping),
//               icon: Package,
//             },
//           ].map(
//             (section) =>
