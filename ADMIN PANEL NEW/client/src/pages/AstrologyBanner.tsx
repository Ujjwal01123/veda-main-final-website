...
export function AstrologyBanner() {
  ...
  // ✅ Handle file selection (1–6 images)
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      formData.append("sectionName", "astrology");
      ...
      if (res.data.success) {
        alert("✅ Astrology banners uploaded successfully!");
        setImages([]);
        setPreviews([]);
        setAltTexts([]);
        navigate("/banners/view/astrology");
      } else {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-indigo-100 via-background to-accent/5">
      {/* Sidebar */}
      ...
      <div className="flex-1 p-6 overflow-y-auto">
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-2">
            <div className="flex justify-center gap-3 mb-4">
              <div className="w-12 h-12 rounded-full bg-gradient-spiritual flex items-center justify-center shadow-spiritual">
                <Moon className="w-6 h-6 text-spiritual-foreground" />
              </div>
              <h1 className="text-4xl font-bold bg-gradient-spiritual bg-clip-text text-transparent">
                Astrology Banner Settings
              </h1>
            </div>
            <p className="text-muted-foreground max-w-lg mx-auto">
              Upload up to <strong>6 banners</strong> for the Astrology section,
          ...
          <Card className="bg-gradient-card border-border/50 shadow-card p-6">
            <CardHeader>
              <CardTitle className="text-center text-xl font-semibold">
                Upload Astrology Banners (Up to 6 Images)
              </CardTitle>
            </CardHeader>
          ...
          <div className="text-center py-6 text-muted-foreground flex justify-center gap-2">
            ...
            <span>Align your Astrology section with the stars ✨</span>
            <Sparkles className="w-4 h-4" />
          </div>
        </div>
      </div>
...
//       {/* ✅ Main form content on the right */}
//       <div className="flex-1 p-6 overflow-y-auto">
...
//             </div>
//             <p className="text-muted-foreground max-w-lg mx-auto">
//               Upload <strong>exactly 3 banners</strong> for the Astrology
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-background to-accent/5 p-6">
//       <div className="max-w-4xl mx-auto space-y-8">
//         {/* Back Button */}
//         <Button
//           variant="ghost"
...
//           </div>
//           <p className="text-muted-foreground max-w-lg mx-auto">
//             Upload <strong>exactly 3 banners</strong> for the Astrology section,
//             each with unique alt text and preview.
//           </p>
//         </div>
...
// //       if (res.data.success) {
// //         alert("✅ Astrology banner uploaded successfully!");
// //         setImage(null);
// //         setPreview(null);
// //         setAltText("");
...
// //           </div>
// //           <p className="text-muted-foreground max-w-lg mx-auto">
// //             Upload and preview your cosmic Astrology banner with custom alt text
// //             for SEO.
// //           </p>
// //         </div>
...
// //               <img
// //                 src={preview}
// //                 alt={altText || "Astrology Banner Preview"}
...
// //                   id="altText"
// //                   type="text"
// //                   placeholder="e.g. Astrology zodiac signs alignment banner"
// //                   value={altText}
